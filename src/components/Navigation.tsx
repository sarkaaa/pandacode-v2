      ...
      <ul className="flex flex-wrap gap-5 justify-start items-center sm:justify-center">
        ...
        <li>
          <button 
            ...
            className="cursor-pointer p-1 rounded-md bg-linear-90 hover:from-red-gradient hover:to-purple-gradient dark:hover:from-dark-blue-gradient dark:hover:to-dark-purple-gradient transition-colors dark:text-light"
